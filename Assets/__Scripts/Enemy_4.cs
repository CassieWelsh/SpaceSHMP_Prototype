...
public class Part
{
    // Значения этих трёх полей должны определяться в инспектора
    ...
    [HideInInspector]
    public Material mat; // Матриал для отображения повреждений
}
...
public class Enemy_4 : Enemy
{
    ...
    bool Destroyed(Part prt)
    {
        ...
        {
            return(true);// Вернуть true (то есть: даЮ была уничтожена)
        }
    ...
    void OnCollisionEnter(Collision coll)
    {
        ...
        switch (other.tag)
        {
            case "ProjectileHero":
                ...
                // Получить разрушающую сил из Projectile.type и Main.WEAP_DICT
